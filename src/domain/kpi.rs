...
impl TryFrom<CoreKpi> for Reach1Plus {
    ...
    fn try_from(value: CoreKpi) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            value: KpiValueVariant::Value(KpiPercentageValue(calculate_reach(&value.contact_distribution_in_impressions, 1)))
        })
    }
}
...
impl TryFrom<CoreKpi> for Reach2Plus {
    ...
    fn try_from(value: CoreKpi) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            value: KpiValueVariant::Value(KpiPercentageValue(calculate_reach(&value.contact_distribution_in_impressions, 2)))
        })
    }
}
...
impl TryFrom<CoreKpi> for Reach3Plus {
    ...
    fn try_from(value: CoreKpi) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            value: KpiValueVariant::Value(KpiPercentageValue(calculate_reach(&value.contact_distribution_in_impressions, 3)))
        })
    }
}
...
fn calculate_reach(contract_distribution: &Vec<f32>, reach: usize) -> f32 {
    ...
    if contract_distribution.len() > 0
    {
        ...
        {
            n_plus_contacts_distribution[i] = n_plus_contacts_distribution[i - 1] - contract_distribution[i - 1];
        }
    }
