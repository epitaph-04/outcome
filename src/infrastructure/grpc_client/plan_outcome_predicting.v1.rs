...
impl ErrorType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            ErrorType::UndefinedEvaluationAudience => {
                "ERROR_TYPE_UNDEFINED_EVALUATION_AUDIENCE"
            }
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "ERROR_TYPE_UNDEFINED_EVALUATION_AUDIENCE" => {
                Some(Self::UndefinedEvaluationAudience)
            }
...
pub mod plan_outcome_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_statistics_for_plan(
            ...
            tonic::Response<super::GetStatisticsForPlanResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
