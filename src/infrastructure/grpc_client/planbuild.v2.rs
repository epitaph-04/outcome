...
pub struct AddressableBuyDetail {
    ...
    pub cost_per_thousand_impressions: ::core::option::Option<
        super::super::common::v1::Money,
    >,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
impl BuyableMediumType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            BuyableMediumType::HighlyStrategical => {
                "BUYABLE_MEDIUM_TYPE_HIGHLY_STRATEGICAL"
            }
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
...
pub mod plan_build_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn begin_plan(
            ...
            tonic::Response<super::BeginPlanResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/BeginPlan",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("planbuild.v2.PlanBuildService", "BeginPlan"));
        ...
        pub async fn update_plan_budget(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "UpdatePlanBudget"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn update_plan_name(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "UpdatePlanName"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete_plan(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/DeletePlan",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("planbuild.v2.PlanBuildService", "DeletePlan"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn approve_plan(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/ApprovePlan",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("planbuild.v2.PlanBuildService", "ApprovePlan"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn archive_plan(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/ArchivePlan",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("planbuild.v2.PlanBuildService", "ArchivePlan"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn reopen_plan(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/ReopenPlan",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("planbuild.v2.PlanBuildService", "ReopenPlan"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn update_status(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/UpdateStatus",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "UpdateStatus"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn copy_plan(
            ...
            tonic::Response<super::CopyPlanResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/CopyPlan",
            );
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        pub async fn update_plan_source(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "UpdatePlanSource"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn create_plan_variant(
            ...
            tonic::Response<super::CreatePlanVariantResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "CreatePlanVariant"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn add_linear_buy(
            ...
            tonic::Response<super::AddLinearBuyResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/AddLinearBuy",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "AddLinearBuy"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn add_addressable_buy(
            ...
            tonic::Response<super::AddAddressableBuyResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "AddAddressableBuy"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn update_buy_input_grp(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "UpdateBuyInputGrp"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn update_cost_per_grp(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "UpdateCostPerGrp"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn update_cost_per_thousand_impressions(
            ...
            request: impl tonic::IntoRequest<
                super::UpdateCostPerThousandImpressionsRequest,
            >,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
            self.inner
                .ready()
        ...
        pub async fn remove_buy(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/RemoveBuy",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("planbuild.v2.PlanBuildService", "RemoveBuy"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_buys(
            ...
            tonic::Response<super::GetBuysResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/GetBuys",
            );
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        pub async fn get_plans(
            ...
            tonic::Response<super::GetPlansResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/GetPlans",
            );
            let mut req = request.into_request();
            req.extensions_mut()
        ...
        pub async fn get_all_plans(
            ...
            tonic::Response<super::GetAllPlansResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/GetAllPlans",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("planbuild.v2.PlanBuildService", "GetAllPlans"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_archived_plans(
            ...
            tonic::Response<super::GetArchivedPlansResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "GetArchivedPlans"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_buy_report(
            ...
            tonic::Response<super::GetBuyReportResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/planbuild.v2.PlanBuildService/GetBuyReport",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("planbuild.v2.PlanBuildService", "GetBuyReport"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_linear_buys_overview(
            ...
            tonic::Response<super::GetLinearBuysOverviewResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
